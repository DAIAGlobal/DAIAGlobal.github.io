...
export default function DAIAHoldingLanding() {
  ...
  const dataPackages = isEN
    ...
    : [
        { id: 'starter-node', name: 'Starter Node — USD 10/mes', price: '$10/mo', desc: '1 vCPU · 1 GB RAM · 20 GB SSD · 2 TB transferencia · Gestión básica', bullets: ['1 vCPU','1 GB RAM','20 GB SSD','2 TB transferencia','Gestión básica'] },
        { id: 'pro-node', name: 'Pro Node — USD 25/mes', price: '$25/mo', desc: '2 vCPU · 4 GB RAM · 40 GB SSD · Backups semanales · Soporte prioritario', bullets: ['2 vCPU','4 GB RAM','40 GB SSD','Backups semanales','Soporte prioritario'] },
        { id: 'ultra-node', name: 'Ultra Node — USD 70/mes', price: '$70/mo', desc: '4 vCPU · 8 GB RAM · 80 GB SSD · Alta disponibilidad básica · Backups diarios · SLA 99.9%', bullets: ['4 vCPU','8 GB RAM','80 GB SSD','Alta disponibilidad básica','Backups diarios','SLA 99.9%'] },
        { id: 'enterprise', name: 'Enterprise — A cotizar', price: 'A cotizar', desc: 'Soluciones personalizadas en arquitectura, escalamiento, redundancia, redes privadas y auditorías de seguridad.' },
        { id: 'cloud-engine', name: 'DAIA Cloud Engine — Infraestructura Gestionada', price: 'A cotizar', desc: 'Plataforma de servidores cloud con operación completa incluida. Servidores virtuales (VPS) optimizados, seguridad, firewall y hardening, backups automáticos, monitoreo y alertas, optimización del sistema operativo, migración de datos y aplicaciones y soporte técnico con SLA.' , bullets: ['Servidores virtuales (VPS) optimizados','Seguridad, firewall y hardening','Backups automáticos','Monitoreo y alertas','Optimización del sistema operativo','Migración de datos y aplicaciones','Soporte técnico con SLA'] },
        { id: 'model-marketplace', name: 'Model Marketplace — IA On-Demand', price: 'Facturación por consumo', desc: 'Modelos listos para integración mediante API. Transcripción (Whisper), modelos de clasificación, modelos de anomalías y análisis de clientes. Facturación por consumo (pay-per-use).', bullets: ['Transcripción (Whisper)','Modelos de clasificación','Modelos de anomalías','Análisis de clientes','Facturación por consumo (pay-per-use)'] },
