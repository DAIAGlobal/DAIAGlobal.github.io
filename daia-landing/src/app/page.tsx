...
export default function DAIAHoldingLanding() {
  ...
  const dataPackages = isEN
    ...
    : [
        ...
        { id: 'enterprise', name: 'Enterprise — Enterprise', price: 'Custom', desc: 'Soluciones personalizadas en arquitectura, escalamiento, redundancia, redes privadas y auditorías de seguridad.' },
