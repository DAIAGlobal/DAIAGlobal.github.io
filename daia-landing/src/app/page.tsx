...
export default function DAIAHoldingLanding() {
  ...
  const dataPackages = isEN
    ...
    : [
        ...
        { id: 'cloud-engine', name: 'DAIA Cloud Engine — Infraestructura Gestionada', price: 'Contact', desc: 'Infraestructura operativa: Servidores virtuales (VPS), firewall, backups, monitoreo y seguridad, tuning y optimización de SO, migración de datos y aplicaciones, soporte directo y SLA empresarial. Ejemplos de precios: Starter $10/mes · Pro $25/mes · Ultra $70/mes · Enterprise: contáctanos.', bullets: ['Servidores virtuales (VPS)','Firewall, backups, monitoreo y seguridad','OS tuning y optimización','Migración de datos y aplicaciones','Soporte técnico directo y SLA empresarial'] },
